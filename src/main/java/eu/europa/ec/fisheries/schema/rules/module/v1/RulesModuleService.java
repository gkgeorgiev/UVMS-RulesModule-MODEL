 ...
 * 2016-07-08T12:24:12.435+02:00
 * Generated source version: 2.7.6
 * 
 */
@WebServiceClient(name = "RulesModuleService", 
                  wsdlLocation = "file:/C:/uvms-git-release/models/RulesModule/src/main/resources/contract/RulesModuleService.wsdl",
...
public class RulesModuleService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/uvms-git-release/models/RulesModule/src/main/resources/contract/RulesModuleService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(RulesModuleService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/uvms-git-release/models/RulesModule/src/main/resources/contract/RulesModuleService.wsdl");
        }
        WSDL_LOCATION = url;
    }
