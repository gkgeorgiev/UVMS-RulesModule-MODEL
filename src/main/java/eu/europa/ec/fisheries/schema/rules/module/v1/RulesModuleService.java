 ...
 * 2016-09-30T12:33:51.096+02:00
 * Generated source version: 2.7.6
 * 
 */
@WebServiceClient(name = "RulesModuleService", 
                  wsdlLocation = "file:/C:/uvms-2.1.0-jessamine-boffin/models/RulesModule/src/main/resources/contract/RulesModuleService.wsdl",
...
public class RulesModuleService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/uvms-2.1.0-jessamine-boffin/models/RulesModule/src/main/resources/contract/RulesModuleService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(RulesModuleService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/uvms-2.1.0-jessamine-boffin/models/RulesModule/src/main/resources/contract/RulesModuleService.wsdl");
        }
        WSDL_LOCATION = url;
    }
